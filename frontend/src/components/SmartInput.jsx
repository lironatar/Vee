...
const SmartInput = React.forwardRef(({ html, setHtml, placeholder, autoFocus, style, onKeyDown, date, setDate, time, setTime, showSpan = true }, ref) => {
    ...
    React.useImperativeHandle(ref, () => contentEditable.current);
